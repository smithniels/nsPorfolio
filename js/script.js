...
function shadow(e)
{
	let walk = 30; // Niels Note <-- this changes the range of the annoying effect. If I ever decide to have a click event to turn that off this would be the var to target. Just set it to zero :D 
	const
	{
		offsetWidth: width,
		offsetHeight: height
